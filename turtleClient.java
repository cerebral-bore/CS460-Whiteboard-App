...
public class turtleClient implements ActionListener{
	...
	JPanel titlePanel, timePanel, buttonPanel, displayPanel;
	...
	*/
	...
	public JPanel createContentPane(){
		...
		displayPanel.setLocation(10,150);
		displayPanel.setSize(480,400);
		displayPanel.setBorder(BorderFactory.createStrokeBorder(new BasicStroke(3.0f)));
	...
	private static void createGUI(){
		...
		turtleClient demo = new turtleClient();
